...
<html>
    ...
    <body >
        <h1 class="container-md">Elegi el consorcio a liquidar</h1><br>
            ...
            <table class="table table-striped">
                ...
                <th style="text-align: center">Seleccionar</th>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <button class="btn btn-outline-dark" onclick="window.location = 'nuevaExpensaServlet2?id_consorcio=${pro.id_consorcio }';" ><img src="img/condo.png" height="35" width="35"></button>  
                        </td>
