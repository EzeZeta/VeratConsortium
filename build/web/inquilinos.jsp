...
<%@page import="Gestores.GestorInquilinos"%>
...
<html>
    ...
    <body >
        <h1 class="container-md">Listado de Inquilinos</h1><br>
        <div class="container-md">     
            <table class="table table-striped">
                <th style="text-align: center">ID</th><th style="text-align: center">Consorcio</th>
                ...
                <th style="text-align: center">Editar</th><th style="text-align: center">Eliminar</th>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <button class="btn btn-outline-dark" onclick="window.location = 'eliminarInquilinoServlet?id_persona=${pro.id_persona }';" >Eliminar</button>
                        </td>
                        <td>
                            <button  class="btn btn-outline-dark" onclick="window.location = 'editarInquilinoServlet?id_persona=${pro.id_persona }';" >Editar</button>              
                        </td>
                    </tr>
        ...
        <div class="container-md"><button class="btn btn-dark"  onclick="window.location = 'nuevoInquilino.jsp';" >Nuevo Inquilino</button>
