 ...
 * @author Usuario
 */
@WebServlet(name = "eliminarConsorciosServlet", urlPatterns = {"/eliminarConsorciosServlet"})
public class eliminarConsorciosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        gc.bajaLogicaPH(id_consorcio);
        gc.bajaLogicaConsorcio(id_consorcio);
