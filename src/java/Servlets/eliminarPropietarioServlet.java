 ...
 * @author Usuario
 */
@WebServlet(name = "eliminarPropietarioServlet", urlPatterns = {"/eliminarPropietarioServlet"})
public class eliminarPropietarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        gp.bajaLogicaPropietario(id_persona);
